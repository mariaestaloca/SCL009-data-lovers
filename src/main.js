...
// document.getElementById("btnSecNivEdu").addEventListener("click", (e) => {
//     e.preventDefault();
...
//     const selectNivEduCountry = document.getElementById("selectNivEduCountry");
//     const container = document.getElementById("containerselectNivEduCountry");

//     selectNivEduCountry.addEventListener("change",() => {
//      let condicion = selectNivEduCountry.options[selectNivEduCountry.selectedIndex].text; 
//      console.log(condicion);
//     });
   
//      //El segundo parametro preguntas 
//     // se utiliza selectedIndex para identificar seleccion del usuario con las opciones dadas 
    
//     const selectNivEduIndicator = document.getElementById( "selectNivEduIndicator");
//     const containerDos = document.getElementById("containerselectNivEduPreguntas");
    
//     selectNivEduIndicator.addEventListener("change",()=>{
//       let condicion2 = selectNivEduIndicator.options[selectNivEduIndicator.selectedIndex].text;
//       console.log(condicion2);
//     });


//      //El tercer parametro años // recordar luego agrupar por intervalos de año 
//      // aunque en data.js la generacion de la tabla si contempla los 10 datos 
//     // se utiliza selectedIndex para identificar seleccion del usuario con las opciones dadas 

//     const selectNivEduDecade = document.getElementById("selectNivEduDecade");
//     const containerTres = document.getElementById("containerselectNivEduDecada");

//      selectNivEduDecade.addEventListener("change",()=>{
//      let condicion3 = selectNivEduDecade.options[selectNivEduDecade.selectedIndex].text;
